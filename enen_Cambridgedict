...
class encn_Cambridge {
    ...
    renderCSS() {
        let css = `
        <div style="text-align: center;"><span class="pos">noun [ C or U ]</span><span class="tran"><span class="eng_tran">(the performance of) words that are believed to have a magical effect when spoken or sung</span></span></div>
        <style>
                ...
                ul.sents {font-size:1.3em; list-style:square inside; margin:3px 0;padding:5px;background:rgba(13,71,161,0.1); border-radius:5px;text-align: center}
                li.sent  {margin:0; padding:0;}
                span.eng_sent {margin-right:5px;}
                span.chn_sent {color:#0d47a1;}
            </style><ul class="sents"><li class="sent" style="text-align: center;"><span class="eng_sent">Around the fire, tribal elders chanted <b>incantation</b>s.</span></li></ul>`;
        return css;
    }
}
